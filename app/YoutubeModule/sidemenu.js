class LoginController {
  ...
  callSignUpAPI(userName, password, genre, twitter, instagram, age, gender) {
    const data = $.ajax({
      url: "http://15.168.10.223:8000/api/register_user/",
      type: "POST",
      dataType: "json",
      data: {
        name: userName,
...
class SideMenuController {
  ...
  callYoutubeAPI(query) {
    const data = $.ajax({
      url: "http://15.168.10.223:8000/api/search_music/",
      type: "POST",
      dataType: "json",
      data: { query: query },
      timeout: 3000,
  ...
  callGetFavoriteAPI() {
    const data = $.ajax({
      url: "http://15.168.10.223:8000/api/get_favorite_music/",
      type: "POST",
      dataType: "json",
  ...
  onClickFavoriteRegisterButton(id) {
    const data = $.ajax({
      url: "http://15.168.10.223:8000/api/create_favorite/",
      type: "POST",
      dataType: "json",
      data: {
        user_id: this.userID,
  ...
  onClickFavoriteRemoveButton(id) {
    const data = $.ajax({
      url: "http://15.168.10.223:8000/api/delete_favorite/",
      type: "POST",
      dataType: "json",
      data: {
        user_id: this.userID,
